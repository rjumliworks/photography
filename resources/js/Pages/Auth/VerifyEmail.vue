                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <form @submit.prevent="submit">
                                        <div class="w-100 mb-3">
                                            <BButton variant="success" type="submit" class="w-100" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Send Verification Email</BButton>
                                        </div>

                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Didn't receive a code ?
                                                <Link href="/login" class="fw-semibold text-success text-decoration-underline">Resend</Link> | <Link href="/logout" method="post" class="fw-semibold text-danger text-decoration-underline">Logout</Link>
                                            </p>
                                        </div>
                                    </form>
                                </div>
